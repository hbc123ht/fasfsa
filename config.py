...
_C.RPN.TEST_POST_NMS_TOPK = 5   # if you encounter OOM in inference, set this to a smaller number
...
_C.RPN.TEST_PER_LEVEL_NMS_TOPK = 5
...
_C.TEST.RESULT_SCORE_THRESH_VIS = 0.05   # only visualize confident results
