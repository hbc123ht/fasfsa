python3 train.py --config DATA.BASEDIR=data/60k_crop_augmented_maskrcnn_coco_json \
                          ...
                          DATA.NUM_WORKERS=2 \
                          EXPERIMENT_NAME=MaskRCNN-R50C41x-COCO_finetune_with_real_data-docrop_and_rotate \
                          --load weights/COCO-MaskRCNN-R50C41x.npz \
                          --logdir log/MaskRCNN-R50C41x-COCO_finetune_with_real_data-docrop_and_rotate